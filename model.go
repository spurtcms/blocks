...
func (Blockmodel BlockModel) DeleteBlockCollection(blockcollection TblBlockCollection, DB *gorm.DB) error {
	...
	if err := DB.Table("tbl_block_collections").Where("block_id = ? and tenant_id = ? ", blockcollection.BlockId, blockcollection.TenantId).UpdateColumns(map[string]interface{}{"is_deleted": blockcollection.IsDeleted, "deleted_by": blockcollection.DeletedBy, "deleted_on": blockcollection.DeletedOn}).Error; err != nil {
